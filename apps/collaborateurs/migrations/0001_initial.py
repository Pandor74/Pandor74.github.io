    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('statut', models.CharField(blank=True, choices=[('En création', 'En création'), ('Validé', 'Validé'), ('Envoyé', 'Envoyé')], default='En création', max_length=255)),
                ('createur', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['numero'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_contact', models.CharField(choices=[('clients', 'Client'), ('entreprises', 'Executant'), ('collaborateurs', 'Interne')], default='entreprises', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_inscription_personne', models.DateTimeField(default=datetime.datetime(2018, 12, 17, 15, 18, 23, 528698, tzinfo=utc), verbose_name="Date d'inscription ")),
