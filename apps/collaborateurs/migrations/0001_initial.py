    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_contact', models.CharField(choices=[('client', 'Client'), ('executant', 'Executant'), ('interne', 'Interne')], default='executant', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_inscription_personne', models.DateTimeField(default=datetime.datetime(2018, 12, 17, 9, 17, 3, 115024, tzinfo=utc), verbose_name="Date d'inscription ")),
