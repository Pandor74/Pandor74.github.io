    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('num_SIRET', models.CharField(max_length=13, null=True, validators=[django.core.validators.RegexValidator(message='Le numéro SIRET doit être composé de 13 chiffres exactement', regex='^(?P<siret>\\d{13})$')], verbose_name='N°SIRET')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('competence', models.CharField(choices=[('Façades', 'Façades'), ('Electricité', 'Electricité'), ('Non renseigné', 'Non renseigné'), ('Autre', 'Autre'), ('Autre', 'Autre'), ('Autre', 'Autre'), ('Autre', 'Autre')], default='NR', max_length=255)),
            ],
            options={
                'ordering': ['competence'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('num_SIREN', models.CharField(max_length=9, null=True, validators=[django.core.validators.RegexValidator(message='Le numéro SIREN doit être composé de 9 chiffres exactement ', regex='^(?P<siren>\\d{9})$')], verbose_name='N°SIREN (9 premiers chiffres du N°SIRET) ')),
            ],
        ),
        migrations.CreateModel(
            name='Lot',
